  ...
  return (
    <section id="skills" className="py-16 bg-gray-100">
      <div className="container mx-auto px-6 md:px-12 lg:px-24 text-center">
        ...
        {/* Using Now */}
        <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mt-10 mb-4">USING NOW:</h3>
        ...
        {/* Learning */}
        <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mt-12 mb-4">LEARNING:</h3>
